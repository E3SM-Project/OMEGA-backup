function(build_core CORE)
  ...
  # NOTE that for now we only build omega from this directory
  # may add more cores later
  ...
  add_custom_command(
    ...
    COMMAND ${CMAKE_BINARY_DIR}/omega/src/tools/parse < ${CORE_BLDDIR}/Registry_processed.xml
